/* Copyright漏 2000 - 2024 SuperMap Software Co.Ltd. All rights reserved.*/
(function () {
  ...
  function load(config) {
      ...
      inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/locales/" + resourceLanguage + "/resources.js");
      inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/tokengenerator.js");
      ...
      if (!inArray(excludes, 'example-i18n')) {
          ...
          inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/utils.js");
          inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/localization.js");
      ...
      if (inArray(includes, 'theme')) {
          inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/theme/themeConfig.js");
          inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/theme/theme.js");
      }
      ...
      if (inArray(includes, 'widgets.alert')) {
          inputScript("http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/js/widgets.js");
      }
  ...
  load({
      libsurl: 'http://10.23.17.229:8090/iserver/iClient/forJavaScript/web/libs'
  });
  window.isLocal = true;
  window.server = document.location.toString().match(/file:\/\//) ? "http://10.23.17.229:8090" : document.location.protocol + "//" + document.location.host;
