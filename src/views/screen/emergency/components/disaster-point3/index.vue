...
export default {
  ...
  props: {
    disasterList: {
      type: Array,
      default: () => [
        { roadName: '遵义绕城高速', code: '灾害点1-崩塌', name: 'Ⅰ级', level: '崩塌' },
        { roadName: '安顺绕城高速', code: '灾害点2-水毁', name: 'Ⅰ级', level: '沉陷' },
        { roadName: '印习高速', code: '灾害点3-水毁', name: 'Ⅱ级', level: '泥石流' },
        { roadName: '松从高速', code: '灾害点4-滑坡', name: 'Ⅱ级', level: '滑坡' },
        { roadName: '毕威高速', code: '灾害点5-崩塌', name: 'Ⅲ级', level: '水毁' }
      ]
    },
    speed: {
      type: Number,
