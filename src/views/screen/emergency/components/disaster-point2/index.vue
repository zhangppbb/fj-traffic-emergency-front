<template>
  <div class="w-full overflow-hidden disaster-point-table">
    <div class="flex w-full table-header mb-xs-vw">
      <div class="cell name truncate overflow-hidden whitespace-nowrap">灾害点名称</div>
      <div class="cell no truncate overflow-hidden whitespace-nowrap">灾害等级</div>
      <div class="cell point truncate overflow-hidden whitespace-nowrap">灾害类型</div>
      <div class="cell level truncate overflow-hidden whitespace-nowrap">气象状况</div>
    </div>
...
export default {
  ...
  props: {
    disasterList: {
      type: Array,
      default: () => [
        { roadName: '灾害点1-崩塌', code: '警示级', name: '崩塌', level: '强降雨' },
        { roadName: '灾害点2-水毁', code: '警示级', name: '沉陷', level: '强降雨' },
        { roadName: '灾害点3-水毁', code: '关注级', name: '泥石流', level: '阴天' },
        { roadName: '灾害点4-滑坡', code: '关注级', name: '滑坡', level: '晴天' },
        { roadName: '灾害点5-崩塌', code: '关注级', name: '水毁', level: '小雨' }
      ]
    },
    speed: {
      type: Number,
