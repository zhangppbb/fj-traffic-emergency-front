    ...
    <seamless-scroll :data="disasterList" class="td-body-container">
      <div class="scroll-content flex flex-col">
        ...
        >
          ...
          <div class="truncate cell  no whitespace-nowrap overflow-hidden" :title="item.code" :style="{color:item.code==='警示级'?'rgba(255, 63, 63, 1)':'rgba(252, 215, 44, 1)'}">
            {{ item.code }}
          </div>
...
export default {
  ...
  props: {
    disasterList: {
      type: Array,
      default: () => [
        { roadName: "灾害点1-崩塌", code: "警示级", name: "崩塌" },
        { roadName: "灾害点2-崩塌", code: "警示级", name: "沉陷" },
        { roadName: "灾害点3-崩塌", code: "关注级", name: "泥石流" },
      ]
    },
    speed: {
      type: Number,
