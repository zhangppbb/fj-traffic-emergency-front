...
import scanIcon from '@/assets/images/app/scan.gif'
...
export default {
  ...
  methods: {
    ...
    initMap() {
      ...
      // 104.1954, 35.8617
      var map = L.map('map', {
        center: [30.01574858500004, 103.50194978200005],
        zoom: 10,
        ...
        // // 创建 ScanRadar 雷达对象
        // var radar = new L.supermap.plotting.ScanRadar(map, [39.9, 116.4], {
        //   radius: 3000,         // 雷达扫描半径（米）
        //   speed: 1,             // 旋转速度（弧度每秒）
        //   direction: 0,         // 初始角度
        ...
        //   lineWidth: 2,         // 线宽
        //   startAngle: 0,        // 扫描扇形起始角度
        //   endAngle: 60          // 扫描扇形终止角度
        // });
    ...
    new L.supermap.TiledMapLayer("http://10.23.56.29:8090/iserver/services/map-gis-2-2/rest/maps/DataSourcePlan2GIS", {
      transparent: true,
      noWrap: true
      //opacity: 0.6
    }).addTo(map);
    ...
    //   });
      ...
      // 30.01574858500004, 103.50194978200005	

      const marker = L.marker([30.01574858500004, 103.5019497820000], { icon: radarIcon }).addTo(map);
