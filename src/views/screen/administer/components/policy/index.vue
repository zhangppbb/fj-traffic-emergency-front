<template>
  <div class="w-full overflow-hidden disaster-point-table">
    <div class="flex w-full table-header mb-xs-vw">
      <div class="cell name truncate overflow-hidden whitespace-nowrap ">文件名称</div>
      <div class="cell no truncate overflow-hidden whitespace-nowrap ">发布日期</div>
      <div class="cell point truncate overflow-hidden whitespace-nowrap ">文件类型</div>
...
export default {
  ...
  props: {
    disasterList: {
      type: Array,
      default: () => [
        { roadName: "贵州省自然灾害防...", code: "2024-9-25", name: "政策文件", level: "下载" },
        { roadName: "地质灾害防治条例", code: "2024-9-25", name: "政策文件", level: "下载" },
        { roadName: "地质灾害防治条例", code: "2024-9-25", name: "政策文件", level: "下载" },
        { roadName: "地质灾害防治条例", code: "2024-9-25", name: "政策文件", level: "下载" },
        { roadName: "地质灾害防治条例", code: "2024-9-25", name: "政策文件", level: "下载" },
      ]
