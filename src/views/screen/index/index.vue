  ...
  <div class="screen-page">
    ...
    <div class="h-full flex box-border">
      ...
      <div class="left-part part-container">
          ...
          <ChartWrapper
          class="chart-wrapper-item structure-type-stats"
          title="基础设施类型分布分析"
        >
          <StructureTypeStats :data="distributionData" />
        </ChartWrapper>

          <ChartWrapper
          class="chart-wrapper-item monitor-point"
          title="监测点统计"
        >
          <MonitorPoint :points="monitorPointData" />
        </ChartWrapper>
      ...
      <div class="right-part part-container">
        <ChartWrapper
           title="设备运行状态监控"
         >
           <DeviceStatusMonitor v-bind="equipmentData" />
        </ChartWrapper>
...
import { MonitorPoint } from '../components'
...
.part-container {
  ...
  & > .chart-wrapper-item:last-of-type {
    margin-bottom: 0;
  }

  & > .chart-wrapper-item.monitor-point {
    flex: 1;
    height: 100%;
    display: flex;
    flex-direction: column;
...
.middle-part {
  ...
  & > .map-controls-container {
    ...
    // line-height: 20px;
    // border-radius: px2vw(4);
    // background-color: rgba(0,26,90,0.5);
    ...
    & > .map-controls-item {
      width: px2vw(200);
      height: px2vh(84);
      background-image: url('./assets/warn-bg.png');
      background-size: 100% 100%;
      position: relative;
      margin-right: px2vw(44);
      .title {
        color: #fff;
        font-size: px2vw(14);
        text-align: center;
    ...
    & > .map-controls-item.level1 {
      .value {
        color: #DC1717;
      }
    }
    & > .map-controls-item.level2 {
      .value {
        color:#FFE47D;
      }
    }
    & > .map-controls-item.level3 {
      .value {
        color:#7ED6FF ;
      }
    }

     & > .map-controls-item:last-of-type {
      margin-right: 0;
    }
  }
