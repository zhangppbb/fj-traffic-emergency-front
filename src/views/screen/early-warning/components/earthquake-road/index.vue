<template>
  <div class="w-full overflow-hidden disaster-point-table">
    ...
    <div class="issue-button-container mt-sm-vw text-md-vw" @click="$emit('confirm')">
      <img src="~@/views/screen/early-warning/components/disaster-point2/assets/icon.png" class="icon mr-xs-vw" alt="">
      巡查任务下发
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    disasterList: {
      type: Array,
      default: () => [
        { roadName: "夏蓉高速", code: 0, grade1: 0, grade2: 0 },
        { roadName: "银昆高速", code: 2, grade1: 0, grade2: 2 },
        { roadName: "G219", code: 1, grade1: 0, grade2: 1 },
        { roadName: "连霍高速", code: 9, grade1: 1, grade2: 8 },
        { roadName: "S217", code: 0, grade1: 0, grade2: 0 },
      ],
    },
    speed: {
      type: Number,
