...
// 1	2025-3-18 19:21:53	104.59	29.64	8	3.4	四川内江市威远县
      // const earthQuakeMarker = L.marker([29.64, 104.59], {
      //   icon: earthQuakeIcon,
      // }).addTo(map);

      // earthQuakeMarker.on("click", function () {
      //   // self.isBianPo = true
      ...
      weatherData.forEach(o => {
        const marker = L.marker([o.latitude, o.longitude], { icon: icon }).addTo(
          map
        );
