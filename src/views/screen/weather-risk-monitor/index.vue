    ...
    <div class="h-full flex box-border">
      ...
      <div class="top-part">
        <div class="top-item">
          ...
          title="公路影响"
        >
        <Influence :data="highwayInfluence"></Influence>
        </ChartWrapper>
        </div>
        ...
        <div class="top-item">
          ...
          title="水运影响"
        >
        <Influence :data="waterInfluence"></Influence>
        </ChartWrapper>
        </div>
        ...
        <WeatherMonitor />
          ...
          title="综合健康指数"
        >
        <Influence :data="healthIndex"></Influence>
        </ChartWrapper>
        </div>

         <div class="top-item predict">
          <ChartWrapper
          class="chart-wrapper-item"
          title="未来1小时风险预测"
        >
      ...
      <div class="right-part part-container">
        <ChartWrapper
         ...
         <div class="depth-monitor-container">
           <div class="tab-container flex justify-center">
             <div :class="{
              'tab-item': true,
              active: depthMonitorType === 1
             }" @click="changeDepthMonitorType(1)">关键公路走廊</div>
             <div :class="{
              'tab-item': true,
              active: depthMonitorType === 2
             }" @click="changeDepthMonitorType(2)">重点港口枢纽</div>
           </div>
         </div>

         <!-- 关键公路走廊 -->
          <HighwayCorridor v-if="depthMonitorType === 1" />
          <!--重点港口枢纽  -->
          <PortHub v-else-if="depthMonitorType === 2" />
        </ChartWrapper>
      </div>
    </div>
  </div>
...
// 是否显示应急事件标注
  ...
  methods: {
     ...
     * @param {*} type
     */
    changeDepthMonitorType(type) {
      this.depthMonitorType = type
    },
...
.depth-monitor-container {
  & > .tab-container {
    ...
    .tab-item {
      ...
      border-radius: px2vh(18);
      text-align: center;
      font-size: px2vw(14);
      background: linear-gradient(90deg, rgba(185,227,244,1) 0%,rgba(152,215,241,1) 50%,rgba(119,203,237,1) 100%);
      color: rgba(35,114,205,1);
    }
