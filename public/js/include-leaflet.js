/* Copyright漏 2000 - 2023 SuperMap Software Co.Ltd. All rights reserved.
 ...
 * which accompanies this distribution and is available at http://www.apache.org/licenses/LICENSE-2.0.html.*/
 (function () {
  ...
  load({
      ...
      disturl: 'http://10.23.17.229:8090/iserver/iClient/forJavaScript/dist'
  });
  window.isLocal = true;
  window.server = document.location.toString().match(/file:\/\//)
      ? 'http://10.23.17.229:8090'
