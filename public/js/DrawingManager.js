 ...
 */
 ...
 (function() {
      ...
      *
      * @example <b>参考示例：</b><br />
      * var map = new BMapGL.Map("container");<br />map.centerAndZoom(new BMapGL.Point(116.404, 39.915), 15);<br />
     ...
     DrawingManager.prototype._bindMarker = function () {
        ...
        var me = this,
         ...
         var clickAction = function (e) {
            ...
            mask.enableEdgeMove();
            // me._dispatchOverlayComplete([marker, operateWindow]);
            // me.close()
         };
     ...
     DrawingManager.prototype._bindCircle = function () {
         ...
         var startAction = function (e) {
             ...
             var distance = radius
             circle = new BMapGL.Circle(centerPoint, distance, me.circleOptions);
         ...
         var moveAction = function (e) {
             ...
             tip_label = new BMapGL.Label('半径：' + radius + '松开完成绘制', {
         ...
         var endAction = function (e) {
            ...
            //  map.setViewport(cz);
             ...
             var distance = (radius/1000).toFixed(2)
             ...
             radiusWindow = new Screenshot('circle', midPoint, distance, circle, me);
             ...
             radiusWindow.addEventListener('radiusinputchange', function (e) {
                var radius = (e.radius * 1000).toFixed(2);
                var distance = (e.radius)
                circle.setRadius(radius);
                ...
                radiusWindow.setInfo(halfLeftPoint, distance);
             ...
             radiusWindow.addEventListener('radiuschange', function (e) {
                 ...
                 var ePoint = getPointByDistance(centerPoint, distance, 'east');
                 var dragLeftPoint = new BMapGL.Point(ePoint.lng, centerPoint.lat);
                 var halflng = ePoint.lng > centerPoint.lng ? (circle.getBounds().getNorthEast().lng + centerPoint.lng) / 2 : (circle.getBounds().getSouthWest().lng + centerPoint.lng) / 2;
                 var halfLeftPoint = new BMapGL.Point(halflng, centerPoint.lat);
                 moveMarker.setPosition(dragLeftPoint);
             ...
             moveMarker.addEventListener('dragging', function (e) {
                 ...
                 var halfLeftPoint = new BMapGL.Point(halflng, centerPoint.lat);
                 var distance = me._map.getDistance(centerPoint, e.latLng)

                 var distance_radius = (distance/1000).toFixed(2)

 
                 e.target.setPosition(dragLeftPoint);
                 radiusWindow.setInfo(halfLeftPoint, (distance_radius));
                 operateWindow.setPosition(dragLeftPoint, isright);
                 polyline.setPath([centerPoint, dragLeftPoint]);
                 radius = distance.toFixed(0);
                 circle.setRadius(distance);
             });
          ...
          * 绘制圆形结束
          */
          var endDragendAction = function (e) {
            //  var cz = map.getViewport(circle.getBounds());
            //  cz.zoom -= 1;
            //  map.setViewport(cz);
             map.removeOverlay(tip_label);
     ...
     Operate.prototype.initialize = function (map) {
         ...
         var html = '<div><span id="confirmOperate"></span><span id="cancelOperate"></span></div>';
         div.innerHTML = html;
     ...
     Screenshot.prototype.initialize = function (map) {
         ...
         if (this.type == 'circle') {
             var html = '<div class="circlShot"><span id="screenshotNum">' + this.number + '</span><input id="circleInput" type="text" /><span class="unit">千米</span></div>';
         }
     ...
     Screenshot.prototype._dispatchRadiusChange = function (opt) {
         this.dispatchEvent('radiusinputchange', opt);
     };
